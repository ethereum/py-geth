...
```bash
$ python -m geth.install v1.10.14
```
...
>>> install_geth('v1.10.14')
```

The installed binary can be found in the `$HOME/.py-geth` directory, under your
home directory.  The `v1.10.14` binary would be located at
`$HOME/.py-geth/geth-v1.10.14/bin/geth`.
...
```shell
$ python update_geth.py v1.10.14
```
